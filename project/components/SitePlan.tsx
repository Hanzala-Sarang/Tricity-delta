      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-[#000000] mb-4">
            Master Plan & <span className="text-[#4B7B87]">Plans</span>
          </h2>
        ...
        <div className="grid gap-12">
          ...
          <div className="space-y-6">
            ...
            {/* Plan Selection Tabs */}
            <div className="flex justify-center space-x-2 flex-wrap gap-2"> {/* Added flex-wrap and gap for mobile */}
              {floorPlans.map((plan) => (
                <button
                  key={plan.id}
